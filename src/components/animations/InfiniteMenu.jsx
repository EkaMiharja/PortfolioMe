...
class InfiniteGridMenu {
  ...
  #init(onInit) {
    ...
    this.discGeo = new DiscGeometry(56, 0.8);
        ...
        item =>
          new Promise(resolve => {
            ...
            img.onerror = () => {
              ...
              fallback.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" fill="%234F46E5" rx="20"/><text x="50" y="68" font-size="40" text-anchor="middle" fill="white" font-family="sans-serif">' + item.title.slice(0, 2).toUpperCase() + '</text></svg>';
